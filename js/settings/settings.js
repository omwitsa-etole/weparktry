...
const home  = document.getElementById("page-content").innerHTML;

function passwordPage(){
	const body = document.getElementById("page-content");
	body.innerHTML = `
<div class="content container-fluid" style="margin-top:11%;">
<div class="row">
...
<div class="col-sm-6">
<div class="form-group">
<label>Emails App Password</label>
...
const mainFunction = ()=>{
	...
	if(hash.includes("password")){
		passwordPage()
	}else if(hash.includes("email")){
		emailPage()
	}else if(hash.includes("cron")){
		databasePage()
	}else if(hash.includes("notification")){
		notificationPage()
	}else if(hash.includes("rate")){
		rateSettings()
...
window.onhashchange= mainFunction