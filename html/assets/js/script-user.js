!function(t) {
    ...
    function _(e, a, o) {
        e.length > 0 && e.each(function() {
            "add" === o && t(this).data("switch") === a.data("switch") && t(this).addClass("link-disable"),
            "remove" === o && t(this).data("switch") === a.data("switch") && t(this).removeClass("link-disable")
        })
    }
    z.length > 0 && z.each(function() {
        t(this).on("change", function() {
            var e = t(this)
              , a = e.data("switch");
            e.is(":checked") ? (t(F + "." + a).addClass("switch-active").slideDown(300),
            _(D, t(this), "remove")) : e.is(":checked") || (t(F + "." + a).removeClass("switch-active").slideUp(300),
            _(D, t(this), "add"))
        }),
        t(this).is(":checked") ? (t(F + "." + t(this).data("switch")).addClass("switch-active").slideDown(100),
        _(D, t(this), "remove")) : (t(F + "." + t(this).data("switch")).removeClass("switch-active").slideUp(100),
        _(D, t(this), "add"))
    }),
    D.length > 0 && D.each(function() {
        t(this).on("click", function(e) {
            var a = t(this)
              , o = a.data("switch");
            if (a.hasClass("link-disable"))
                return !1;
            t(F + "." + o).toggleClass("switch-active").slideToggle(300),
            e.preventDefault()
        })
    });
    var M = t(".input-file");
    ...
    var O = t(".upload-zone");
    O.length > 0 && (Dropzone.autoDiscover = !1,
    O.each(function() {
    ...
    o.on("click", "body", function(t) {
        J.is(t.target) || 0 !== J.has(t.target).length || X.is(t.target) || 0 !== X.has(t.target).length || (X.removeClass("active"),
        j.removeClass("contact-active")),
        !q.is(t.target) && 0 === q.has(t.target).length && !U.is(t.target) && 0 === U.has(t.target).length && e.width() < 992 && (q.removeClass("active"),
        U.removeClass("active"),
        X.removeClass("short"),
        j.removeClass("information-active")),
        Q.is(t.target) || 0 !== Q.has(t.target).length || Z.is(t.target) || 0 !== Z.has(t.target).length || (Q.removeClass("active"),
    ...
    G.length > 0 && G.on("click", function(e) {
        ...
        if (o) {
            ...
            n.length > 0 && (n.slice(0, i).removeClass("hidden"),
            n.length <= i && (a.parent().fadeOut("slow"),
            t("#" + o).addClass("loaded")))
        }
    }),
    ...
    tt.length > 0 && tt.on("click", function() {
        ...
        Y.addClass("active"),
        null == t && Cookies.set("twz-offer", "true", {
            expires: 1,
            path: ""
        }),
        !1
